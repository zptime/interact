		...
		'<div class="plupload_wrapper">' +
			'<div class="ui-widget-content plupload_container">' +
				...
				'<tr>' +
					...
					'<td class="plupload_cell plupload_file_action">操作</td>' +
				'</tr>' +
				'</table>' +
	...
	_handleFileStatus: function(file) {
		...
		switch (file.status) {
			case plupload.DONE:
				...
				iconClass = 'plupload_action_icon ui-icon-circle-check';
			...
			case plupload.FAILED:
				...
				iconClass = 'plupload_action_icon ui-icon-alert';
			...
			case plupload.QUEUED:
				...
				iconClass = 'plupload_action_icon ui-icon-circle-minus';
				break;

			case plupload.UPLOADING:
				actionClass = 'ui-state-highlight plupload_uploading';
				iconClass = 'plupload_action_icon ui-icon-circle-arrow-w';
	...
	_addFiles: function(files) {
		...
		file_html = '<li class="plupload_file ui-state-default plupload_delete" id="{id}" style="width:{thumb_width}px;">' +
			...
			'<div class="plupload_file_status">' +
				'<span class="plupload_file_percent">待上传... </span>' +
			...
			'<div class="plupload_file_action">' +
				'<div class="plupload_action_icon ui-icon-circle-minus">删除</div>' +
			'</div>' +
