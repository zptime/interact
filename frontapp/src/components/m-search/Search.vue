...
.inp{height: 1.6rem;padding:0 0.4rem 0 1.5rem;text-align: left;float: left;display: block;width: 14rem;background-image: url("./fdj.png");background-size: 1rem 1rem;background-repeat: no-repeat;background-position: 3% center;font-size: 0.75rem;}
